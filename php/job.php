...
if (isset($_GET['search'])){
        ...
        $query = mysqli_query($connection,"SELECT * FROM job WHERE Title LIKE '%$searchq%' OR description LIKE '%$searchq%'") or die("Could not search");
  ...
  <div class="logout"><a href="logout.php"><img src='../img/logout-icon.png'>Logout</a></div>
    ...
    <div class="container" style='margin-top:11%'>
       <?php
            echo ('<h3 class="h3">Your search returned '.$count.' results</h3>');
        ?>
        <div class="row">
           <?php
                if ($count ==0){
            ...
            <div class="col-md-6 col-sm-6">
                <div class="product-grid6">
                    <div class="product-content" style="margin-top:1%">
                        ...
                        <div class="price"><h5 style="color:black">Vacancy</h5><?php echo $data['VacancyCount'];?>
                        </div>
