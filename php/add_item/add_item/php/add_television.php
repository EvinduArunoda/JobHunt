...
<body>
	<div class="wrapper">
		<header>
			<div class="main">
				<form>
					<div class="box" style="float: left; left: 17.5%; top: 20%; padding-top: 5px;">
						...
						<input type='text' name='display' placeholder='Display Size'>
						<input type='text' name='model' placeholder='Model'>
						<input type='text' name='category' placeholder='Category'>
					</div>
					<div class="box" style="float: right; top: 20%; left: 55%;">
						<input type='text' name='colours' placeholder='Colours'>
						<input type='text' name='type' placeholder='Type'>						
						<input type='text' name='power' placeholder='Power Supply'>
